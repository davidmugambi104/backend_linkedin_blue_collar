...
class Worker(db.Model):
    ...
    # Messages: primaryjoin ensures proper linking
    ...
    verifications = db.relationship(
        "Verification", backref="worker", cascade="all, delete-orphan"
    )
    ...
    def to_dict(self):
        return {
            ...
            "average_rating": (
                float(self.average_rating) if self.average_rating else 0.0
            ),
