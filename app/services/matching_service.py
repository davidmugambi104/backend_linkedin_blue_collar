...
from ..models import Job, Worker, WorkerSkill, Skill, Application, Review
...
class MatchingService:
    ...
    def get_job_recommendations_for_worker(worker_id, limit=20, max_distance_km=50):
        ...
        for job in jobs:
            ...
            # Check location
            if worker.location_lat and worker.location_lng and job.location_lat and job.location_lng:
                ...
                if distance <= max_distance_km:
                    ...
                    distance_penalty = (distance / max_distance_km) * 0.2  # Up to 20% penalty
    ...
    def get_worker_recommendations_for_job(job_id, limit=20, max_distance_km=50):
        ...
        worker_skills = WorkerSkill.query.filter_by(skill_id=job.required_skill_id).all()
