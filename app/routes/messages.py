...
from ..utils.permissions import worker_required, employer_required
...
def get_conversations():
    ...
    for msg in messages:
        ...
        if conv_id not in conversations or msg.created_at > conversations[conv_id]['last_message_time']:
    ...
    conversations_list = sorted(conversations.values(), key=lambda x: x['last_message_time'], reverse=True)
