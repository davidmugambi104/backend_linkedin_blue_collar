...
from ..models import User, Verification, Worker, UserRole
from ..schemas import VerificationSchema, VerificationCreateSchema, VerificationUpdateSchema
...
def create_verification():
    ...
    if data['worker_id'] != worker.id:
        return jsonify({'error': 'You can only submit verifications for your own profile'}), 403
