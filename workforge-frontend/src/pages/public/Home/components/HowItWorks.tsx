    ...
    <div className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
          {/* Worker Journey */}
          <div className="relative p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Create Profile</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Find & Apply</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mr-3">
                  <HandThumbUpIcon className="h-4 w-4 text-gray-600 dark:text-gray-400" />
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Get Hired & Earn</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="relative p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Create Company Profile</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Post Jobs</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Hire & Manage</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
